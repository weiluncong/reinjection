...
class nidCase(EvalCase.EvalCase):
    ...
    def case(self):
        ...
        d_hppSts            = self.getLastData(self.getSignal(15))
        ...
        if self.iaccSwitchFirstTime !=0:
            if ((self.currentTime - self.iaccSwitchFirstTime)>4 and (self.currentTime - self.iaccSwitchFirstTime)<8):
                ...
                if(not(self.errorFlag_lat or self.errorFlag_lng or self.errorFlag_hppSts)):
    ...
    # ///<HPP状态信号 :[/],(0,0,7),[/],(1,0),标识HPP状态信号    hpp_sts
    # ///<0:Invalid
    # ///<1:硬件初始化
    # ///<2:定位算法初始化
    # ///<3:关联传感器故障
